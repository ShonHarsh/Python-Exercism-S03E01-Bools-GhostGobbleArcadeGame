![Banner](Data/Images/Python-Exercism-S03E01-Bools-GhostGobbleArcadeGame-Banner.png)

### Python-Exercism-S03E01-Bools-GhostGobbleArcadeGame
...
### Submission Command
`exercism submit "Exercism\python\ghost-gobble-arcade-game\arcade_game.py"`

## Testing Command
`pytest -o markers=task`

![Banner](Data/Images/Python-Exercism-S03-Bools-Title.png)
